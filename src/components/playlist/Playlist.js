...
function Playlist() {
    ...
    // console.log("CHECK PLAYLIST: ", myState2.playlistData);
   
    // console.log("CHECK TRACKS: ", myState2.playlistData.tracks);

    // let description = myState2.playlistData.description;
    // const regex = /<[^>]*>/ig;
            ...
            {/* <div className="playlist">
                <div className="playlist__info">
                    ...
                    <div className="playlist__infoText">
                        ...
                        <p><b>{myState2.playlistData.owner.display_name}</b></p>
                    </div>
                </div>
            </div> */}
                    ...
                    <div className="playlist">
                        <div className="playlist__info">
                            ...
                            <div className="playlist__infoText">
                                ...
                                <h2>{myState2.playlistData.name}</h2>
                                {/* <p>{myState2.playlistData.description}</p> */}
                                <p>{myState2.playlistData.description.replaceAll(/<[^>]*>/ig, '')}</p>
